...
(FamilyTree._defaultConfig = function (e) {
        ...
        if (!FamilyTree.isNEU(t) && t.length)
            if (i) {
                ...
                Array.isArray(i.pids) &&
                    (1 != i.pids.length && console.error("addChildAndPartnerNodes partnerData.pids has to have one partner"), (d = this.get(i.pids[0])), Array.isArray(d.pids) || (d.pids = []), d.pids.push(i.id), l.push(d));
            ...
            if (FamilyTree.isNEU(h) || h.getAttribute(FamilyTree.attr.control_node_circle_menu_wrraper_id) != e) {
                ...
                f.menu)) {
                    ...
                    this._buttonsInterval.push(
                        FamilyTree.animate(k, { transform: [1, 0, 0, 1, 0, 0] }, { transform: [1, 0, 0, 1, E, L] }, 250, FamilyTree.anim.outBack, function (e) {
    ...
    (FamilyTree.accentFold = function (e) {
        return (e = e.toString().toLowerCase()).replace(/([Ã Ã¡Ã¢Ã£Ã¤Ã¥])|([Ã§])|([Ã¨Ã©ÃªÃ«])|([Ã¬Ã­Ã®Ã¯])|([Ã±])|([Ã²Ã³Ã´ÃµÃ¶Ã¸])|([ÃŸ])|([Ã¹ÃºÃ»Ã¼])|([Ã¿])|([Ã¦])/g, function (e, t, i, r, a, n, l, o, s, d, c) {
                ...
                v = function (t) {
                    if (h) {
                        ...
                        if (s.left || s.right || s.up || s.down) {
                            ...
                            var E = (i.x - h.x) / d,
                                L = (i.y - h.y) / d;
                            if (((u[4] = y + E), (u[5] = g + L), !e._dragEventFired && (Math.abs(i.x - h.x) > FamilyTree.FIRE_DRAG_NOT_CLICK_IF_MOVE || Math.abs(i.y - h.y) > FamilyTree.FIRE_DRAG_NOT_CLICK_IF_MOVE)))
    ...
    (FamilyTree.prototype._nodeMouseDownHandler = function (e, t, i) {
        if (this.config.enableDragDrop) {
            ...
            var s = this,
                ...
                f = s.getScale(),
                u = e.cloneNode(!0);
            u.setAttribute("data-n-id", "draging"), d.insertBefore(u, d.firstChild), (u.style.opacity = 0.7);
            var y = function (e, t) {
                    if (null != e) {
                        t.classList.remove("bft-drag-over");
                ...
                g = function (t) {
                    if (c) {
                        ...
                        if (g.left || g.right || g.up || g.down) {
                            ...
                            var N = (i.x - c.x) / f,
                                M = (i.y - c.y) / f;
                            if (((m[4] = p + N), (m[5] = h + M), !e._dragEventFired && (Math.abs(i.x - c.x) > FamilyTree.FIRE_DRAG_NOT_CLICK_IF_MOVE || Math.abs(i.y - c.y) > FamilyTree.FIRE_DRAG_NOT_CLICK_IF_MOVE)))
                ...
                T = function (t) {
                    if (
                        ...
                        return e._dragEventFired && FamilyTree.events.publish("drop", [s, n.id, void 0, u]), d.removeChild(u), void (s._gragStartedId = null);
                    var r = s.getNode(l);
                    if (!1 === FamilyTree.events.publish("drop", [s, n.id, r.id, u])) return y(l, o), d.removeChild(u), void (s._gragStartedId = null);
    ...
    (FamilyTree.manager._createNodes = function (e) {
        ...
        for (c = 0; c < C.length; c++) {
            ...
            for (F = 0; F < R.length; F++) {
                (z = o[R[F]]).collapsed || ((z.parentPartner = z.parent), (z.parent = g), (z.isChildOfPartner = !0), g.children.push(z));
            }
            for (F = N.length - 1; F >= 0; F--) if (M[N[F]]) for (u = 0; u < M[N[F]].length; u++) g.children.push(o[M[N[F]][u]]), L++, -1 == B.indexOf(N[F]) && B.push(N[F]);
            for (F = 0; F < I.length; F++) {
                var z = o[I[F]];
                g.children.push(z);
            }
            for (F = 0; F < A.length; F++) if (M[A[F]]) for (u = 0; u < M[A[F]].length; u++) g.children.push(o[M[A[F]][u]]), O++, -1 == U.indexOf(A[F]) && U.push(A[F]);
            for (F = 0; F < P.length; F++) {
                (z = o[P[F]]).collapsed || ((z.parentPartner = z.parent), (z.parent = g), (z.isChildOfPartner = !0), g.children.push(z));
            }
            (g.partnerSeparation = Math.max(B.length, U.length) * t.partnerChildrenSplitSeparation + t.minPartnerSeparation),
                I.length || !L || O
                    ? I.length || L || !O
                        ? I.length || 1 != L || 1 != O
                            ? I.length || L || O
        ...
        ie = { nodes: o, roots: s };
        return FamilyTree.events.publish("nodes-initialized", [e, ie]), { nodes: ie.nodes, roots: ie.roots, rootList: d };
    }),
            ...
            for (var i = [], r = 0; r < e.groupDottedLines.length; r++) {
                ...
                if (!i.has(n))
                    for (var l = 0; l < t.length; l++)
                        if (t[l].id == a.rootId) {
                            ((c = JSON.parse(JSON.stringify(t[l]))).id = `balkan_group_dotted_${a.rootId}_balkan_id_${t[l].id}`),
                                (c.pid = void 0),
                                (c.stpid = t[l].id),
                                t.push(c),
                                i.push(n),
            ...
            for (r = 0; r < e.dottedLines.length; r++) {
                ...
                for (l = 0; l < t.length; l++)
                    if (t[l].id == d.from) {
                        var c;
                        if (
                            (((c = JSON.parse(JSON.stringify(t[l]))).id = `balkan_dotted_${d.rootId}_balkan_id_${t[l].id}`),
    ...
    (FamilyTree.prototype._slinks = function (e, t) {
        ...
        function n(t, n, l) {
            ...
            l && ((L = n.id), (O = t.id)),
                (i +=
                    ("<g " + FamilyTree.attr.s_link_from + '="{from}" ' + FamilyTree.attr.s_link_to + '="{to}">').replace("{from}", L).replace("{to}", O) +
    ...
    FamilyTree.events.on("renderbuttons", function (e, t) {
        if (t.node && t.node.tags && t.node.tags.has("group-dotted-lines")) {
            var i = e.getScale(),
                ...
                a = "";
            t.node.min
                ? (r.nodeGroupDottedOpenButton || console.error(`[${t.node.templateName}].nodeGroupDottedOpenButton is not defined`),
                ...
                : (r.nodeGroupDottedCloseButton || console.error(`[${t.node.templateName}].nodeGroupDottedCloseButton is not defined`),
    ...
    (FamilyTree.elements.textbox = function (e, t, i, r) {
        ...
        var n = "";
        return (
            t.btn && (n = `<a href="#" data-input-btn="" class="bft-link bft-link-bft-button">${t.btn}</a>`),
            {
                html: `<div class="bft-form-field" style="min-width: ${i};">\n                    <div class="bft-input" data-bft-input="" ${a.disabledAttribute} ${a.vlidators}>\n                        <label for="${
                    a.id
                }">${FamilyTree._escapeGreaterLessSign(a.label)}</label>\n                        <input ${a.readOnlyAttribute} data-binding="${FamilyTree._escapeDoubleQuotes(a.binding)}" maxlength="256" id="${a.id}" name="${
                    a.id
    ...
    (FamilyTree.elements.select = function (e, t, i, r) {
        ...
        return a.doNotRender
            ...
            : {
                  html: `<div class="bft-form-field" style="min-width: ${i};">\n                    <div class="bft-input" data-bft-input="" ${a.disabledAttribute} ${a.vlidators}>\n                        <label for="${
                      a.id
                  }">${FamilyTree._escapeGreaterLessSign(a.label)}</label>\n                        <select data-binding="${FamilyTree._escapeDoubleQuotes(a.binding)}" ${a.readOnlyAttribute} id="${a.id}" name="${
                      a.id
                  }">\n                            ${(function () {
    ...
    (FamilyTree.elements.date = function (e, t, i, r) {
        ...
        return a.doNotRender
            ...
            : {
                  html: `<div class="bft-form-field" style="min-width: ${i};">\n                    <div class="bft-input" data-bft-input="" ${a.disabledAttribute} ${a.vlidators}>\n                        <label for="${
                      a.id
                  }" class="hasval">${FamilyTree._escapeGreaterLessSign(a.label)}</label>\n                        <input data-binding="${FamilyTree._escapeDoubleQuotes(a.binding)}" ${a.readOnlyAttribute} maxlength="256" id="${
                      a.id
    ...
    (FamilyTree.prototype.showTreeMenu = function (e) {
        ...
        for (g = 0; g < o.length; g++)
            ((o[g].fid == c.id && FamilyTree.isNEU(o[g].mid)) || (o[g].mid == c.id && FamilyTree.isNEU(o[g].fid))) &&
                (o[g].fid == c.id ? (o[g].mid = "_ft_partner_for_single_child") : o[g].mid == c.id && (o[g].fid = "_ft_partner_for_single_child"), m.push(o[g]), T.push(o[g].id));
        if (T.length) {
            var b = { id: "_ft_partner_for_single_child", pids: [e], templateName: "partner", _ft_method: "addPartnerAndParentNodes", _ft_childIds: T, _ft_partnerData: { pids: [e] }, _ft_id: e };
